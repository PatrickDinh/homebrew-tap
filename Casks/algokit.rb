cask "algokit" do
  binary_path arm: "dist/algokit-2.0.6-macos_arm64.tar.gz", intel: "dist/algokit-2.0.6-macos_x64.tar.gz"
  version "2.0.6"
  ...
  url "https://github.com/PatrickDinh/algokit-cli/releases/download/#{version}/#{binary_path}"
  name "algokit"
